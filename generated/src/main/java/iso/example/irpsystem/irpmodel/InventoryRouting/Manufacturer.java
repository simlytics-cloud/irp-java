...
<P extends ImmutableManufacturerProperties, S extends ManufacturerState, I extends ImmutableManufacturerState>  extends Facility<P, S, I> {
    ...
    public Manufacturer(I initialState, String identifier, P properties) {
