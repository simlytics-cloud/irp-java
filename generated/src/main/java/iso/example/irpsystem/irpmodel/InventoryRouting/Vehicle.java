...
<P extends ImmutableVehicleProperties, S extends VehicleState, I extends ImmutableVehicleState>  extends ScheduledDevsModel<LongSimTime, S> {
    ...
    public Vehicle(I initialState, String identifier, P properties) {
