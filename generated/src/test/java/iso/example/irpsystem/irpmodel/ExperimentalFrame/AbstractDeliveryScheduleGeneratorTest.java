...
public abstract class AbstractDeliveryScheduleGeneratorTest<A> extends DevsModelTest<LongSimTime> {
  ...
  protected static final String modelIdentifier = "deliveryScheduleGenerator";
  protected static final String coupledModelName = "deliveryScheduleGeneratorCoupledModelTest";
  ...
  protected PDevsCouplings buildCouplings() {
    PDevsCouplings couplings = PDevsCouplings.builder(coupledModelName)
        .addConnection(modelIdentifier, "postDeliverySchedule",
            testAcceptorIdentifier, "fromPostDeliverySchedule")
        .build();
    return couplings;
  }
